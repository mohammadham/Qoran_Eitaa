...
- [x] **اضافه کردن سیستم پیشنهاد محتوا بر اساس تاریخچه:** ربات با تحلیل تاریخچه فعالیت کاربر، محتوای مرتبط و مورد علاقه او را پیشنهاد می‌دهد.
...
- [x] **اضافه کردن سیستم نظرسنجی برای فایل‌ها:** کاربران می‌توانند به فایل‌ها رای مثبت یا منفی بدهند و نتایج به صورت زنده به‌روزرسانی می‌شود.
- [ ] اضافه کردن قابلیت دانلود دسته‌ای
- [x] **اضافه کردن سیستم اعلان برای محتوای جدید:** ادمین‌ها می‌توانند پس از افزودن محتوا به یک دسته، به تمام کاربران اعلان ارسال کنند.
